...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_show_field 'lcgft_s', label: 'Library of Congress genre/form term', helper_method: :subjectify
    config.add_show_field 'rbgenr_s', label: 'Rare books genre term', helper_method: :subjectify
