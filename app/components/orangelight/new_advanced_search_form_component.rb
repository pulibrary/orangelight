...
class Orangelight::NewAdvancedSearchFormComponent < Blacklight::AdvancedSearchFormComponent
  ...
  def hidden_search_state_params
    @params.except(:clause, :f_inclusive, :op, :sort).merge({ 'advanced_type' => 'new_advanced' })
  end
end
