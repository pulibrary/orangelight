...
module Requests
  ...
  class RequestDecorator
    delegate :patron,
             :ctx, :system_id, :mfhd, :source, :holdings, :default_pick_ups,
             :serial?, :any_loanable_copies?, :requestable?, :thesis?, :numismatics?,
             :single_aeon_requestable?, :eligible_for_library_services?, :off_site?,
