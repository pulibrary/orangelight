...
module ApplicationHelper
  ...
  # If there is not lang attribute it announces the same as having lang='en'
  def language_iana_primary_value
    @document[:language_iana_primary_s].present? ? @document[:language_iana_primary_s].first : 'en'
  end
end
