...
namespace :browse do
  ...
  task load_names: :environment do
    sql_command, facet_request, conn = BrowseLists.connection
  ...
  task load_name_titles: :environment do
    sql_command, facet_request, conn = BrowseLists.connection
    BrowseLists.load_facet(sql_command, facet_request, conn,
                           'name_title_browse_s', "#{BrowseLists.table_prefix}_name_titles")
  end
  ...
  task load_call_numbers: :environment do
    sql_command, facet_request, conn = BrowseLists.connection
  ...
  task load_names_backup: :environment do
  ...
  task load_name_titles_backup: :environment do
  ...
  task load_subjects_backup: :environment do
  ...
  task load_call_numbers_backup: :environment do
