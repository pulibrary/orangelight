...
describe Requests::RequestableDecorator do
  ...
  describe "#pick_up?" do
    ...
    context "a user eligible to pick up" do
      ...
      context "borrow_direct?" do
        let(:stubbed_questions) { default_stubbed_questions.merge(on_shelf?: true, holding_library_in_library_only?: false, scsb_in_library_use?: false, on_order?: false, in_process?: false, traceable?: false, aeon?: false, borrow_direct?: true) }
        it 'can not be picked up' do
          expect(decorator.pick_up?).to be_falsey
        end
      end
      ...
      context "on_shelf" do
        let(:stubbed_questions) { default_stubbed_questions.merge(on_shelf?: true, holding_library_in_library_only?: false, scsb_in_library_use?: false, on_order?: false, in_process?: false, traceable?: false, aeon?: true, borrow_direct?: false, ill_eligible?: false, services: ['on_shelf']) }
      ...
      context "has item data and circulates and borrow_direct?" do
        let(:stubbed_questions) { default_stubbed_questions.merge(on_shelf?: false, recap?: true, holding_library_in_library_only?: false, scsb_in_library_use?: false, on_order?: false, in_process?: false, traceable?: false, aeon?: false, borrow_direct?: true) }
        it 'can not be picked up' do
          expect(decorator.pick_up?).to be_falsey
        end
      end
      ...
      context "has item data and circulates and annex? and borrow_direct?" do
        let(:stubbed_questions) { default_stubbed_questions.merge(on_shelf?: false, recap?: false, annex?: true, holding_library_in_library_only?: false, scsb_in_library_use?: false, on_order?: false, in_process?: false, traceable?: false, aeon?: false, borrow_direct?: true) }
        it 'can not be picked up' do
          expect(decorator.pick_up?).to be_falsey
        end
      end
  ...
  describe "#fill_in_pick_up?" do
    ...
    context "eligible to pick up and item_data and on_shelf? and circulates and borrow_direct" do
      let(:stubbed_questions) { default_stubbed_questions.merge(item_data?: true, on_shelf?: true, circulates?: true, holding_library_in_library_only?: false, scsb_in_library_use?: false, on_order?: false, in_process?: false, traceable?: false, aeon?: false, borrow_direct?: true) }
      it 'can not be fill_in_pick_up?' do
        expect(decorator.fill_in_pick_up?).to be_falsey
      end
    end
  ...
  describe "#will_submit_via_form?" do
    ...
    context "no item data and does not circulate and eligible_for_library_services?" do
      let(:stubbed_questions) { default_stubbed_questions.merge(item_data?: false, circulates?: false, services: ["on_shelf"], recap_edd?: false, scsb_in_library_use?: false, ill_eligible?: false, on_order?: false, in_process?: false, traceable?: false, user_barcode: '111222', borrow_direct?: false, ask_me?: false, open_libraries: ['abc'], library_code: 'abc', aeon?: false) }
      it 'will not be submitted' do
        expect(decorator.will_submit_via_form?).to be_falsey
      end
    end
    ...
    context "no item data and does not circulate and eligible_for_library_services? and traceable and no user barcode " do
      let(:stubbed_questions) { default_stubbed_questions.merge(item_data?: false, circulates?: false, services: ["on_shelf"], recap_edd?: false, scsb_in_library_use?: false, ill_eligible?: false, on_order?: false, in_process?: false, traceable?: true, eligible_for_library_services?: false, borrow_direct?: false, ask_me?: false, open_libraries: ['abc'], library_code: 'abc', aeon?: false) }
      it 'will not be submitted' do
        expect(decorator.will_submit_via_form?).to be_falsey
      end
    end
    ...
    context "no item data and does not circulate and eligible_for_library_services? and in process and no user barcode" do
      let(:stubbed_questions) { default_stubbed_questions.merge(item_data?: false, circulates?: false, services: ["on_shelf"], recap_edd?: false, scsb_in_library_use?: false, ill_eligible?: false, on_order?: false, in_process?: true, eligible_for_library_services?: false, borrow_direct?: false, ask_me?: false, open_libraries: ['abc'], library_code: 'abc', aeon?: false) }
      it 'will not be submitted' do
        expect(decorator.will_submit_via_form?).to be_falsey
      end
    end
    ...
    context "no item data and does not circulate and eligible_for_library_services? and on_order" do
      let(:stubbed_questions) { default_stubbed_questions.merge(item_data?: false, circulates?: false, services: ["on_shelf"], recap_edd?: false, scsb_in_library_use?: false, ill_eligible?: false, on_order?: true, eligible_for_library_services?: false, borrow_direct?: false, ask_me?: false, open_libraries: ['abc'], library_code: 'abc', aeon?: false) }
      it 'will not be submitted' do
        expect(decorator.will_submit_via_form?).to be_falsey
      end
    end
