...
RSpec.describe Orangelight::SortNormalize do
  it 'removes punctuation and spaces' do
    ...
    expect(normalizer.normalize('Ζουργός, Ισίδωρος, 1964-')).to eq 'ζουργοσ ισιδωροσ 1964' # Note that this uses the incorrect sigma (if we were displaying, we would use ισίδωρος)
