...
RSpec.describe Requests::ApplicationHelper, type: :helper,
  ...
  describe 'firestone pick_up_choices' do
    ...
    let(:submit_button_disabled) { helper.submit_button_disabled(requestable_list) }
    it 'lewis is a submitable request' do
      expected_choices = '<div id="fields-print__23724990920006421" class="collapse request--print"><div><ul class="service-list">'\
                         '<li class="service-item">Requests for pick-up typically take 2 business days to process.</li></ul></div>'\
                         '<div id="fields-print__23724990920006421_card" class="card card-body bg-light">'\
                         '<input type="hidden" name="requestable[][pick_up]" id="requestable__pick_up_23724990920006421" '\
                         'value="{&quot;pick_up&quot;:&quot;PN&quot;,&quot;pick_up_location_code&quot;:&quot;lewis&quot;}" '\
                         'class="single-pick-up-hidden" autocomplete="off" /><label class="single-pick-up" style="" for="requestable__pick_up_23724990920006421">'\
                         'Pick-up location: Lewis Library</label></div></div>'
  ...
  describe "#hidden_fields_item" do
    ...
    context "no services" do
      ...
      it 'shows hidden fields' do
        puts helper.hidden_fields_item(requestable)
