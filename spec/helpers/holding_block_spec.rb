  ...
  describe '#holding_block helpers' do
    ...
    context '#holding_block_search' do
      ...
      let(:expected_result) do
        "<ul><li class=\"holding-status\" data-availability-record=\"true\" data-record-id=\"1\" data-holding-id=\"3580281\" data-bound-with=\"false\"><span class=\"availability-icon badge bg-secondary\">Loading...</span><div class=\"library-location\" data-location=\"true\" data-record-id=\"1\" data-holding-id=\"3580281\"><span class=\"results_location\">Rare Books and Special Collections - Rare Books and Special Collections - Reference Collection in Dulles Reading Room</span> &raquo; <span class=\"call-number\">PS3539.A74Z93 2000</span></div></li><li><span class=\"badge bg-primary\" data-availability-cdl=\"true\"></span></li><li class=\"holding-status\" data-availability-record=\"true\" data-record-id=\"1\" data-holding-id=\"3595800\" data-bound-with=\"false\"><span class=\"availability-icon badge bg-secondary\">Link Missing</span><div class=\"library-location\">Online access is not currently available.</div></li><li><span class=\"badge bg-primary\" data-availability-cdl=\"true\"></span></li><li><a class=\"availability-icon badge bg-secondary more-info\" href=\"/catalog/1\">View Record for Full Availability</a></li></ul>"
      end
    ...
    context '#holding_block_search with both links and holdings' do
      ...
      let(:expected_result) do
        <<~END_RESULT.strip
          <ul><li class="holding-status" data-availability-record="true" data-record-id="1" data-holding-id="3580281" data-bound-with="false"><span class="availability-icon badge bg-secondary">Loading...</span><div class="library-location" data-location="true" data-record-id="1" data-holding-id="3580281"><span class="results_location">Rare Books and Special Collections - Rare Books and Special Collections - Reference Collection in Dulles Reading Room</span> &raquo; <span class="call-number">PS3539.A74Z93 2000</span></div></li><li><span class="badge bg-primary" data-availability-cdl="true"></span></li><li>\n    <span class="availability-icon badge bg-primary">Online</span>\n    <div class="library-location"><a target="_blank" rel="noopener" href="https://library.princeton.edu/resource/28076">library.princeton.edu</a></div>\n</li>\n<li><span class="badge bg-primary" data-availability-cdl="true"></span></li><li>\n    <span class="availability-icon badge bg-primary">Online</span>\n    <div class="library-location"><a target="_blank" rel="noopener" href="https://library.princeton.edu/resource/28076">library.princeton.edu</a></div>\n</li>\n<li><a class="availability-icon badge bg-secondary more-info" href="/catalog/1">View Record for Full Availability</a></li></ul>
        END_RESULT
      end
      it 'matches the expected result' do
        expect(search_result).to eq(expected_result)
    ...
    context '#holding_block_search with a missing location code' do
      ...
      before { stub_holding_locations }
      let(:expected_result) do
        "<ul><li class=\"holding-status\" data-availability-record=\"true\" data-record-id=\"1\" data-holding-id=\"3580281\" data-bound-with=\"false\"><span class=\"availability-icon badge bg-secondary\">Loading...</span><div class=\"library-location\" data-location=\"true\" data-record-id=\"1\" data-holding-id=\"3580281\"><span class=\"results_location\">Rare Books and Special Collections - Rare Books and Special Collections - Reference Collection in Dulles Reading Room</span> &raquo; <span class=\"call-number\">PS3539.A74Z93 2000</span></div></li><li><span class=\"badge bg-primary\" data-availability-cdl=\"true\"></span></li><li class=\"empty\" data-record-id=\"1\"><a class=\"availability-icon more-info\" href=\"/catalog/1\"></a></li></ul>"
      end
      it 'matches the expected result' do
        expect(search_result).to eq(expected_result)
      end
