  ...
  it 'tells the patron to contact Marquand directly for marquand items in a carrel' do
    with_controller_class Requests::FormController do
      ...
      allow(requestable).to receive_messages(
        ...
        pick_up_locations: [{ "label" => "Marquand Library" }], on_shelf?: true,
        ill_eligible?: false, location: Requests::Location.new({ 'code' => 'marquand$stacks', 'fulfillment_unit' => 'General' }), charged?: false,
