...
RSpec.describe HoldingRequestsAdapter do
  ...
  describe '#doc_electronic_access' do
    it 'exposes electronic access links' do
      allow(document).to receive(:[]).with('electronic_access_1display').and_return('{"https://pulsearch.princeton.edu/catalog/4609321#view":["arks.princeton.edu"],"https://drive.google.com/open?id=0B3HwfRG3YqiNVVR4bXNvRzNwaGs":["drive.google.com","Curatorial documentation"]}')
