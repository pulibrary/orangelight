...
RSpec.describe Orangelight::ListProcessor do
  ...
  it 'concatenates values into an unordered list' do
    expect(processor.render).to eq([
                                     '<li class="blacklight-field" dir="ltr">Chapter 1</li>',
                                     '<li class="blacklight-field" dir="ltr">Chapter 2</li>'
                                   ])
  end
  ...
  context 'RTL language string' do
    ...
    it 'marks the direction of the <li> as rtl' do
      expect(processor.render).to eq([
                                       '<li class="blacklight-field" dir="rtl">دواني، محمد بن اسعد</li>',
                                       '<li class="blacklight-field" dir="ltr">Chapter 2</li>'
                                     ])
    end
  end
  ...
  context 'HTML that includes RTL content' do
    ...
    it 'marks the direction of the <li> as rtl' do
      expect(processor.render).to eq([
                                       '<li class="blacklight-field" dir="rtl"><span dir="rtl">תל אביב</span> <a dir="ltr">[Browse]</a></li>',
                                       '<li class="blacklight-field" dir="ltr"><span dir="ltr">Tel Aviv</span></li>'
                                     ])
    end
  end
  ...
  context 'field is configured to have a maximum initial display' do
    ...
    it 'hides values after it hits the configured maximum' do
      expect(processor.render).to eq([
                                       '<li class="blacklight-field" dir="ltr">Chapter 1</li>',
                                       '<li class="blacklight-field d-none" dir="ltr">Chapter 2</li>'
                                     ])
    end
  end
end
