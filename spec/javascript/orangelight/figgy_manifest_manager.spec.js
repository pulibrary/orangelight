...
describe('RelatedRecords', function () {
      ...
      resourcesByOrangelightId: [
        {
          ...
          thumbnail: {
            iiifServiceUrl:
              'https://iiif-cloud.princeton.edu/iiif/2/84%2Fda%2Ff9%2F84daf940542e425a8c97fbfe53858b57%2Fintermediate_file',
            thumbnailUrl:
              'https://iiif-cloud.princeton.edu/iiif/2/84%2Fda%2Ff9%2F84daf940542e425a8c97fbfe53858b57%2Fintermediate_file/full/!200,150/0/default.jpg',
            __typename: 'Thumbnail',
          },
          label: 'Pennsylvania: Troy Quadrangle.',
          url: 'https://figgy.princeton.edu/catalog/26b01ff3-eb40-40b0-821c-42fade1cf349',
          memberIds: ['85773d63-8a3a-4cea-b1c3-d9d0196bac3f'],
          embed: {
            type: 'html',
            content:
              '\u003ciframe allowfullscreen="true" id="uv_iframe" src="https://figgy.princeton.edu/viewer#?manifest=https://figgy.princeton.edu/concern/scanned_maps/26b01ff3-eb40-40b0-821c-42fade1cf349/manifest"\u003e\u003c/iframe\u003e',
            status: 'authorized',
            __typename: 'Embed',
          },
          notice: null,
          manifestUrl:
            'https://figgy.princeton.edu/concern/scanned_maps/26b01ff3-eb40-40b0-821c-42fade1cf349/manifest',
        ...
        },
        {
          ...
          thumbnail: {
            iiifServiceUrl:
              'https://iiif-cloud.princeton.edu/iiif/2/0f%2F6a%2F0d%2F0f6a0dcac6054d19987c6048854f505d%2Fintermediate_file',
            thumbnailUrl:
              'https://iiif-cloud.princeton.edu/iiif/2/0f%2F6a%2F0d%2F0f6a0dcac6054d19987c6048854f505d%2Fintermediate_file/full/!200,150/0/default.jpg',
            __typename: 'Thumbnail',
          },
          ...
          embed: {
            type: 'html',
            content:
              '\u003ciframe allowfullscreen="true" id="uv_iframe" src="https://figgy.princeton.edu/viewer#?manifest=https://figgy.princeton.edu/concern/scanned_maps/a65bd135-5356-4613-8089-d90fc445cfda/manifest"\u003e\u003c/iframe\u003e',
            status: 'authorized',
            __typename: 'Embed',
          },
          notice: null,
          manifestUrl:
            'https://figgy.princeton.edu/concern/scanned_maps/a65bd135-5356-4613-8089-d90fc445cfda/manifest',
          __typename: 'ScannedMap',
        },
        {
          ...
          memberIds: ['8fa8bc9b-b0e9-456c-a1ee-a913b2499054'],
          embed: {
            type: 'html',
            content:
              '\u003ciframe allowfullscreen="true" id="uv_iframe" src="https://figgy.princeton.edu/viewer#?manifest=https://figgy.princeton.edu/concern/scanned_maps/595ee476-d247-4339-83e2-bddb90a7d069/manifest"\u003e\u003c/iframe\u003e',
            status: 'authorized',
            __typename: 'Embed',
          },
          notice: null,
          manifestUrl:
            'https://figgy.princeton.edu/concern/scanned_maps/595ee476-d247-4339-83e2-bddb90a7d069/manifest',
          __typename: 'ScannedMap',
        },
      ],
    };
      ...
      resourcesByOrangelightId: [
        {
          ...
          thumbnail: {
            iiifServiceUrl:
              'https://iiif-cloud.princeton.edu/iiif/2/e4%2F2c%2F68%2Fe42c680b62c44540836cb59164cead42%2Fintermediate_file',
            thumbnailUrl:
              'https://iiif-cloud.princeton.edu/iiif/2/e4%2F2c%2F68%2Fe42c680b62c44540836cb59164cead42%2Fintermediate_file/full/!200,150/0/default.jpg',
            __typename: 'Thumbnail',
          },
          label:
          ...
          embed: {
            type: 'html',
            content:
              '\u003ciframe allowfullscreen="true" id="uv_iframe" src="https://figgy.princeton.edu/viewer#?manifest=https://figgy.princeton.edu/concern/scanned_resources/bbc6f6c4-3b92-4ae9-8461-1a14c113af8c/manifest"\u003e\u003c/iframe\u003e',
            status: 'authorized',
            __typename: 'Embed',
          },
          notice: null,
          manifestUrl:
            'https://figgy.princeton.edu/concern/scanned_resources/bbc6f6c4-3b92-4ae9-8461-1a14c113af8c/manifest',
        ...
        },
        {
          ...
          thumbnail: {
            iiifServiceUrl:
              'https://iiif-cloud.princeton.edu/iiif/2/bb%2Ffa%2F24%2Fbbfa247e175149db8d9151180dfa3896%2Fintermediate_file',
            thumbnailUrl:
              'https://iiif-cloud.princeton.edu/iiif/2/bb%2Ffa%2F24%2Fbbfa247e175149db8d9151180dfa3896%2Fintermediate_file/full/!200,150/0/default.jpg',
            __typename: 'Thumbnail',
          },
          label:
            'At a Council held at Boston March 8. 1679,80. : The governour and Council, upon mature consideration of the many loud calls of Providence ... Do therefore appoint and order, that the fifteenth day of April next, be set apart for a day of humiliation and prayer ...',
          ...
          embed: {
            type: 'html',
            content:
              '\u003ciframe allowfullscreen="true" id="uv_iframe" src="https://figgy.princeton.edu/viewer#?manifest=https://figgy.princeton.edu/concern/scanned_resources/54b399c7-f28c-46f6-a7b4-c835a60516c4/manifest"\u003e\u003c/iframe\u003e',
            status: 'authorized',
            __typename: 'Embed',
          },
          notice: null,
          manifestUrl:
            'https://figgy.princeton.edu/concern/scanned_resources/54b399c7-f28c-46f6-a7b4-c835a60516c4/manifest',
          __typename: 'ScannedResource',
        },
      ],
    };
  ...
  test('adds request link when graphql notice returns unauthorized for a PUL thesis', async () => {
    ...
    const availableOnlineElement = document.getElementsByClassName(
      'availability--online'
    );
    const viewerWrapperElement = document.getElementById('view');
    const viewerSet = new FiggyViewerSet(
    ...
    expect(availableOnlineElement[0].getElementsByTagName('li')).toHaveLength(
      2
    );
