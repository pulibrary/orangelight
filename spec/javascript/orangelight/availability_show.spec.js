...
describe('AvailabilityShow', function () {
  ...
  describe('request_availability', () => {
    ...
    test('does not call request_show_page_availability when no availability elements exist', () => {
  ...
  describe('Locations with specific status', () => {
    ...
    test('handle_availability_status handles special locations', () => {
      const element = document.createElement('span');
      const specialStatusLocations = ['marquand$stacks'];

      const checkSpecialSpy = vi
        .spyOn(availabilityShow, 'checkSpecialLocation')
        .mockImplementation(() => {});
      ...
      expect(checkSpecialSpy).toHaveBeenCalledWith('marquand$stacks', element);
    });

    test('checkSpecialLocation handles marquand locations', () => {
      const element = document.createElement('span');

      const result = availabilityShow.checkSpecialLocation(
        'marquand$stacks',
        element
      );
    ...
    test('checkSpecialLocation handles non-marquand special locations', () => {
      const element = document.createElement('span');
    ...
    test('setMarquandStatus sets ask staff status', () => {
      const element = document.createElement('span');

      availabilityShow.setMarquandStatus(element);
