...
set :linked_files, %w{config/database.yml config/blacklight.yml config/secrets.yml config/initializers/devise.rb config/ip_whitelist.yml config/hostname_whitelist.yml}
