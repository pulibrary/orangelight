...
server 'catalog-indexer-qa1.princeton.edu', user: 'deploy', roles: %i[worker indexer]
server 'catalog-indexer-qa2.princeton.edu', user: 'deploy', roles: %i[cron_db worker indexer]
